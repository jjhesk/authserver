...
if (!class_exists('inno_log_db')):
    class inno_log_db
    {
        ...
        */
        ...
        public static function log_vcoin_email($user_id, $hash_code_event_error, $msg = "")
        {
            self::db_access($user_id, $msg, 522, $hash_code_event_error);
            return true;
        }

        public static function log_vcoin_error($user_id, $hash_code_event_error, $msg = "")
        {
            self::db_access($user_id, $msg, 523, $hash_code_event_error);
            return true;
        }

        public static function log_vcoin_new_account($user_id, $hash_code_event_error, $msg = "")
        {
            self::db_access($user_id, $msg, 524, $hash_code_event_error);
            return true;
        }

        public static function log_vcoin_redemption_verification($user_id, $hash_code_event_error, $msg = "")
        {
            self::db_access($user_id, $msg, 525, $hash_code_event_error);
            return true;
        }

        public static function log_vcoin_redemption_verify($user_id, $hash_code_event_error, $msg = "")
        {
            self::db_access($user_id, $msg, 526, $hash_code_event_error);
            return true;
        }

        public static function log_vcoin_third_party_app_transaction($user_id, $hash_code_event_error, $msg = "")
        {
