...
if (!class_exists('GF_notification')) {
    class GF_notification extends gformBase
    {
        ...
        public static function notification_user_registration($notification, $form, $entry)
        {
            ...
            inno_log_db::log_vcoin_email(-1, 19213, "notification start function");
            ...
            if (strtolower($notification["name"]) == "user send verification notification") {
                ...
                /* $context = array(
                     "url" => DOMAIN_API . "email/verify/?vdata=" . implode(";", $vdata),
                 );*/
                $context = array(
                    "url" => DOMAIN_API . "email/verify/?r=" . $entry["id"] . "&e=" . $email . "&h=" . $token . "&d=web_mobile",
                );
            ...
            //}
            inno_log_db::log_vcoin_email(-1, 19213, $notification["message"]);
            return $notification;
        }
