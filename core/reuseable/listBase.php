...
abstract class listBase
{
     ...
     */
    protected function listCateBy($taxonomy_id, $country_cat, $country_term_id, $query_tax_preset = array())
    {
        ...
        $array_terms = get_terms_cpt::postTypeTaxonomy($taxonomy_id, $country_cat, $country_term_id, VPRODUCT, $query_tax_preset);
    ...
    private function catloop($cat, $image = false, $isCate = false, $taxonomy_id)
    {
        ...
        if ($isCate) {
            ...
            $term = get_term($cat->term_id, $taxonomy_id);
            $cat_name = $term->name;
        } else {
